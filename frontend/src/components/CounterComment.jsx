export function CounterComments ({children}) {
  // const nbrComment = '24'

  return (
    // <div className="items-start">
    //     <div className="flex justify-center items-center mx-5 h-9 w-36 border-slate-400 border border-solid rounded transition-colors hover:bg-slate-800 duration-300">
